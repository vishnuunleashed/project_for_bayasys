...
class OccupationDialog extends StatefulWidget {
  String occupation;
  int id;
  OccupationDialog({required this.occupation,required this.id});
...
class _OccupationDialogState extends State<OccupationDialog> {
  ...
  void initState() {
    ...
    textEditingController.text = widget.occupation;
    super.initState();
  }
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                    ...
                    onPressed: (){
                      value.setOccupation(context: context,occupation: textEditingController.text,id: widget.id);
